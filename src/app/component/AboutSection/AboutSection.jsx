...
const AboutSection = () => {
  return (
    <div className="relative lexend-deca-normal flex flex-col md:flex-row items-center w-full my-8 md:my-24 md:px-4 lg:px-24">
      <div className="relative w-11/12 sm:w-10/12 md:w-6/12 flex flex-row items-center justify-center h-auto md:h-[460px] lg:h-[560px] text-white ">
        <div className="w-[152px] h-[152px] bg-white absolute rounded-full  flex flex-col items-center justify-center">
      ...
      <div className="w-11/12 sm:w-10/12 md:w-6/12 flex flex-col items-center md:items-start justify-center h-auto md:h-[560px] px-0 md:px-4 text-[#1f1f1f]">
        <h3 className="text-darkTheme  mt-14 md:mt-0 w-full text-center md:text-start">
          About Us
        </h3>
        <h1 className="lexend-deca-bold text-[30px] md:text-[40px] leading-[44px] text-center md:text-start mt-4">
          Provides Best Approach To Security
        </h1>
        <p className="text-[#9c9c9c]   text-center md:text-start mt-4 w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-y-4 sm:gap-x-[0.5px] w-full sm:w-11/12 bg-white md:bg-[#b4b4b4] mt-4">
          <div className="flex flex-col items-center w-full bg-white px-2">
            <h2 className="lexend-deca-bold text-[30px] text-center md:text-start w-full">
              <CountUp start={1} end={18} duration={2.75} />
              K+
            </h2>
            <p className="text-[#9c9c9c]  text-center md:text-start w-full">
          ...
          <div className="flex flex-col items-center w-full bg-white px-2">
            <h2 className="lexend-deca-bold text-center text-[30px] md:text-start w-full">
