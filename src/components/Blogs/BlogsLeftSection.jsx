...
import { BLOGS, searchBlogs } from "../../../constants/constants";
...
const BlogsLeftSection = ({ query }) => {
  ...
  return (
    <div className="col-span-6 lg:col-span-4 w-full flex flex-col items-start ">
      {searchBlogs1.length < 1 ? (
        <>
          <div className="flex flex-col items-start">
            <h2 className="lexend-deca-bold mt-4 text-[32px] text-darkBlack dark:text-white">
              Nothing Found
            </h2>
            <p className="mt-4 text-lightBlack ">
