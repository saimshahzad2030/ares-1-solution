...
const ServicesSection = () => {
  return (
    <div
      data-aos="fade-up"
      className=" lexend-deca-normal flex flex-col items-center w-full bg-defaultTheme  py-8 md:py-24  px-4 lg:px-20"
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 mt-12 gap-12 overflow-hidden ">
