...
const Testimonials = () => {
  ...
  return (
    ...
    >
      ...
      <h1 className="text-darkTheme text-center dark:text-lightTheme">
        Testimonials
      </h1>
        ...
        >
          <CarouselContent className="flex gap-4">
            {TESTIMONIALS.map((test, index) => (
              ...
              >
                <div className=" group lexend-deca-light flex flex-col items-start p-2 md:p-8 transition-colors duration-300">
                  ...
                  <p className="mt-4 w-full dark:text-white">{test.review}</p>
                  <div className="relative flex flex-row items-center mt-8 w-full">
                    ...
                    <div className="flex flex-col items-start ml-4">
                      <h2 className="lexend-deca-bold text-darkBlack dark:text-white">
                        {test.name}
                      </h2>
      ...
      <p className="py-2 text-center text-sm text-muted-foreground dark:text-white">
